(function () {
    ...
    function initCursor() {
        ...
        var settings = window.WOMCustomCursorSettings || {};
        ...
        var dotSpeed = parseFloat(settings.dotSpeed || 0.45);
        var ringSpeed = parseFloat(settings.ringSpeed || 0.18);

        var hoverSelectors = settings.hoverSelectors || [
            'a',
            'button',
            '[role="button"]',
            'input[type="submit"]',
